...
{
    console.log("\n\nvalue of var name inside the block before changing :  " + name)
    var name = "harsh_changed"
    console.log("value of var name inside the block after changing :  " + name)
}
console.log("value of var name outside the block :  " + name)
